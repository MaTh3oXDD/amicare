# Graph Report - Amicare  (2026-07-31)

## Corpus Check
- 54 files · ~49,133,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 354 nodes · 484 edges · 27 communities (16 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21979151`
...
Cohesion: 0.10
Nodes (18): PageHero, Component, PlacowkaCard, Component, Placowka, PLACOWKI, BadaniaDiagnostyczne, Component (+10 more)
...
Cohesion: 0.32
Nodes (4): createGradientTexture(), HeroBlob, Component, ViewChild
